...
public class GM_GraphManager : MonoBehaviour
{
    ...
    //Commands
    private enum GM_command
    {
        CMD_AddVertex, CMD_AddConnectedVertex, CMD_DuplicateVertex, CMD_DuplicateConnectedVertex, CMD_AddEdge,
        CMD_DeleteVertex, CMD_DeleteEdge, CMD_Move, CMD_Evaluation, CMD_Idle
    }
    ...
    void SetCommand(GM_command cmd)
    {
        ...
        {
            if ((uint)cmd < (uint)GM_command.CMD_Idle + 1)
            {
